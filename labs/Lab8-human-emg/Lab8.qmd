...
:::{.callout-note}
# Prepare for lab by:
- Watch the MusclesII \[[podcast](../../posts/2023-10-16-muscles2/muscles2.qmd)\].
...
## Analysis: Change in contractile force
...
3. Select data points from “RMS Biceps” when books were added.  Enter these values in @tbl-book-force.  The height of the trace correlates with the force produced by the muscle.
...
: Force produced by adding books {#tbl-book-force}
...
: Force produced during coactivation {#tbl-coactivation}
