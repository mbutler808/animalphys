...
Peripheral nerves include _afferent_ (sensory) nerves and _efferent_ (motor and autonomic) nerves.  The individual axons within the nerve vary in diameter, myelination, excitability, threshold, and speed of conduction.  It is important to appreciate that _the threshold voltage required to produce an action potential in each axon reflects the diameter of the individual axon_ – __large diameter axons are stimulated at lower voltages than smaller diameter axons__.  
