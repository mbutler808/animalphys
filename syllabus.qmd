...
Physiology is the science of how life works. The prerequisite is BIOL275. 
...
The course will make use of a [DISCORD server](https://discord.gg/Bqu7tKsd5) to ask and answer questions and discuss any of the course materials. Please engage and provide answers as well as questions. The Instructor will monitor DISCORD and answer questions when appropriate.

# Animal Design Project

Each pair of students will model four physiological systems and write a scientific paper describing the design for one of the physiological systems of an extinct vertebrate. See the [schedule](schedule.qmd) for due dates. One partner will have primary responsibility for reports 1 and 3, and the other partner for reports 2 and 4. 
...
- 
_PLEASE NOTE: Rubrics don’t convey the message that a poorly written paper will get lower marks on all categories_. The writing has to make sense before it can be graded!
:::
